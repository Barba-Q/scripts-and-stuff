#!/bin/bash
# ==============================================================================
# Script to prepare NVIDIA driver installation with DKMS (v2.0)
# PROPRIETARY MODULES for bleeding-edge GPUs (Void Linux).
# FIXED: Proper dracut timing!
# ==============================================================================
...
# PROPRIETARY MODULE NAME:
DKMS_MODULE_NAME="nvidia"
...
MAKE[0]="'make' -j\$(nproc) KERNEL_UNAME=\${kernelver} SYSSRC=/lib/modules/\${kernelver}/build IGNORE_CC_MISMATCH=1"
AUTOINSTALL="yes"
EOF

echo -e "\n${GREEN}Step 8: Building PROPRIETARY modules via DKMS...${NC}"
...
echo -e "\n${GREEN}Step 11: Rebuilding initramfs with new modules and firmware...${NC}"
dracut --force

echo -e "\n\n${GREEN}========================= INSTALLATION COMPLETE! ==========================${NC}"
echo -e "Reboot your machine. You should finally have display output!"
